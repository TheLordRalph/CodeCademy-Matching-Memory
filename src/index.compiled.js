...
var Board = function Board() {
  ...
  var currentBoard = (0, _reactRedux.useSelector)((0, _boardSlice.selectBoard)());
...
var selectBoard = function selectBoard(estate) {
...
var selectVisibleIDs = function selectVisibleIDs(estate) {
...
var selectMatchedIDs = function selectMatchedIDs(estate) {
  return state.board.matched;
};
...
var Card = function Card(_ref) {
  ...
  var visibleIDs = (0, _reactRedux.userSelector)(_boardSlice.selectVisibleIDs);
  var matchedIDs = useSelector(_boardSlice.selectMatchedIDs); // flip card action
...
var Score = function Score() {
  ...
  var cardsMatched = (0, _reactRedux.userSelector)(_boardSlice.selectMatchedIDs);
  return (
    /*#__PURE__*/
